...
def generate_images_for_fonts(word, font_directory, font_sizes, output_directory, max_rotation_angle, bg_color):
...
output_directory = 'output/hindi/ByFontAndAngle'
max_rotation_angle = 90  # Set the maximum rotation angle
bg_color = "white"  # Set the background color

generate_images_for_fonts(word, font_directory, font_sizes, output_directory, max_rotation_angle, bg_color)
